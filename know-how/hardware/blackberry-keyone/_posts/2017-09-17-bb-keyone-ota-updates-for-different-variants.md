...
For convenience, I put up a matrix [here]({% post_url 2017-09-22-bb-keyone-variants-ota-matrix %}).
...
available as you can see from the [matrix]({% post_url 2017-09-22-bb-keyone-variants-ota-matrix %}).
